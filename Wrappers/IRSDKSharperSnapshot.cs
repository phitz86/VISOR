...
{
    public class IRSDKSharperSnapshot : TelemetrySnapshot
    {
        public IRSDKSharperSnapshot(Dictionary<string, object> telemetry, string sessionData, DateTime timestamp)
        {
            Timestamp = timestamp;
